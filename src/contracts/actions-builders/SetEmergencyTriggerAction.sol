...
contract SetEmergencyTriggerAction is ISetEmergencyTriggerAction, ActionBuilder {
   ...
   */
  constructor(address _parent, address _canonGuard, address _emergencyTrigger) ActionBuilder(_parent) {
