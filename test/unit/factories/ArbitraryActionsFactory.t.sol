...
contract UnitArbitraryActionsFactory is Test, Utils {
  ...
  function test_CreateArbitraryActions_WhenCreatingAnArbitraryActionsContract(
    ...
    if (bytes(_arbitraryActionsA.signature).length > 0) {
      bytes4 _expectedSelector = bytes4(keccak256(bytes(_arbitraryActionsA.signature)));
      _arbitraryActionsA.data = abi.encodePacked(_expectedSelector, _arbitraryActionsA.data);
    }
    if (bytes(_arbitraryActionsB.signature).length > 0) {
      bytes4 _expectedSelector = bytes4(keccak256(bytes(_arbitraryActionsB.signature)));
      _arbitraryActionsB.data = abi.encodePacked(_expectedSelector, _arbitraryActionsB.data);
    }
  ...
  function test_CreateArbitraryAction_WhenCreatingAnArbitraryActionsContractWithASingleArbitraryAction(
    ...
    if (bytes(_arbitraryActions.signature).length > 0) {
      bytes4 _expectedSelector = bytes4(keccak256(bytes(_arbitraryActions.signature)));
      _arbitraryActions.data = abi.encodePacked(_expectedSelector, _arbitraryActions.data);
    }
    ...
    assertEq(_savedActions[0].data, _arbitraryActions.data);
